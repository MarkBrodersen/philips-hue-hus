...
module.exports = {
	...
	theme: {
		extend: {
			boxShadow: {
				container:
					'0px 8px 32px rgba(12, 10, 9, 0.25), inset 0px -1px 2px rgba(250, 250, 249, 0.15), inset 0px 6px 12px rgba(250, 250, 249, 0.075), inset 0px -4px 8px rgba(28, 25, 23, 0.25), inset 0px -8px 16px rgba(28, 25, 23, 0.25)',
				...
				red: '0px 8px 32px rgba(185, 28, 28, 0.25), inset 0px -1px 2px rgba(255, 255, 255, 0.4), inset 0px 4px 8px rgba(254, 242, 242, 0.25), inset 0px -4px 8px rgba(185, 28, 28, 0.3), inset 0px -8px 16px rgba(185, 28, 28, 0.25)',
			},
			strokeWidth: {
				3: '3',
			},
